      ...
      <div className="relative w-full max-w-md">
        <div className="card p-8 backdrop-blur-sm bg-white/95">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Create Account</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/login" className="font-semibold text-purple-600 hover:text-indigo-600 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
